...
void Level3Scene::initialise()
{
    ...
    {
        m_game_state.enemies[i] = Entity(walker_texture_id, 4.0f, 1.0f, 1.0f, ENEMY, GUARD, IDLE);
    ...
    for (int i = 0; i < 4; i++) {
        ...
        m_game_state.enemies[i].set_speed(3.8f);
    ...
    for (int i = 0; i < 4; i++) {
        ...
        m_game_state.enemies[idx].set_ai_type(FLYER);
        m_game_state.enemies[idx].set_position(flyer_positions[i]);
        m_game_state.enemies[idx].set_scale(glm::vec3(1.0f));
    ...
    // Zigzag AI
    m_game_state.enemies[11].set_texture_id(flyer_texture_id);
    m_game_state.enemies[11].set_ai_type(ZIGZAG);
    m_game_state.enemies[11].set_position(glm::vec3(1.5f, 1.0f, 0.0f));
    m_game_state.enemies[11].set_scale(glm::vec3(1.0f));
    m_game_state.enemies[11].set_speed(3.5f);
    m_game_state.enemies[11].set_animation_indices(flyer_animation_indices);
    m_game_state.enemies[11].set_animation_cols(5);
    m_game_state.enemies[11].set_animation_rows(1);
    m_game_state.enemies[11].set_animation_frames(5);
    m_game_state.enemies[11].set_animation_index(0);
    m_game_state.enemies[11].set_animation_time(0.0f);

    // Chaser AI
    glm::vec3 chaser_positions[] = {
    glm::vec3(-8.0f, 5.0f, 0.0f),
    glm::vec3(8.5f, 3.5f, 0.0f),
...
void Level3Scene::update(float delta_time)
{
    ...
    {
        m_game_state.next_scene_id = 4; // Level 3
    }
}
